...
- **看得到上一场赛果 + 一键切换下一场**: 修复"离下一场还有十几小时却已经跳到下一场、看不到刚结束那场"的问题。现在跨天也能拿到最近赛果, 默认停留在**上一场结果**, 赛前 30 分钟才切到下一场; 记分牌下方新增 **⏮ 上一场 / 🔴 直播 / 下一场 ⏭** 切换, 随时来回看 (切到上一场再点开, 就能复盘那场的关键事件时间线)。
